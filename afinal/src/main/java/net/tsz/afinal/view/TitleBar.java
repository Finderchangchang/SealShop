...
public class TitleBar extends LinearLayout {
    ...
    public void set_no_left_iv(boolean str_no_left_iv) {
        this.str_no_left_iv = str_no_left_iv;
        if (str_no_left_iv) {
            left_iv.setVisibility(GONE);
            left_tv.setVisibility(GONE);
        }
    ...
    public void setCenterClick(CenterClick rightClick) {
        this.centerClick = rightClick;
    }
